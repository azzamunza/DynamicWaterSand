  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-blue-900">
      ...
      <div className="absolute top-4 left-4 bg-black/50 text-white p-4 rounded-lg backdrop-blur-sm">
        <h1 className="text-2xl font-bold mb-3">Air Bubble Physics</h1>
        <p className="text-sm mb-3">Click and hold to spawn bubbles</p>
        
        <div className="mb-3">
          <label className="text-sm block mb-2">
            Air Amount: {airAmount}%
          </label>
          <input
            type="range"
            min="0"
        ...
        <div className="mb-3">
          ...
          <p className="text-xs mt-1 opacity-75">
            High = stable bubbles, Low = easy merge/split
          </p>
        </div>
